...
const Leaderboard = () => {
    ...
    return (
        <div className='inner-container'>
            <div data-aos="fade-in" className="container py-md-5">
            ...
            <div className="container">
                <div className="row my-5 pt-5">
                    ...
                    <div data-aos="fade-down" className="col-md-4 mt-5 mt-md-0">
                    ...
                    <div data-aos="fade-down" data-aos-delay="200" className="mt-5 mt-md-0 col-md-4">
                        <div className={`${styles.card} card my-2`}>
