...
const SectionOne = () => {
    return (
        <div className="">
            <h1 data-aos="fade-in" className="my-5 text-primary title title2 text-center ">How to register on <div className='coin'>500</div>Casino</h1>
            <div className="container">
                <div className="row gap-4">
                    ...
                    <div  data-aos="fade-out" className="col-md">
