                ...
                <div className="row">
                    <div className="col-md-6 col-lg-4  ">
                        <div className={`${styles.card}  card my-2 card-pink`}>
                            <div className={`${styles.cardImgTopWrapper} m-auto`}>
                                <img src={card_1_img} className={`${styles.cardImgTop} card-img-top mw-100`} alt="..." />
                            </div>
                            ...
                            <a href="#" className="btn btn-primary mt-2">Claim Bonus</a>
                        </div>
                    </div>
                    <div className="col-md-6 col-lg-4  ">
                        <div className={`${styles.card}  card my-2 card-blue`}>
                            <div className={`${styles.cardImgTopWrapper} m-auto`}>
                                <img src={card_2_img} className={`${styles.cardImgTop} card-img-top mw-100`} alt="..." />
                            </div>
                            <div className="card-body">
                                <h5 className="fw-bold text-center">100% Deposit Bonus + 125 FS</h5>
                                <div className="card-text">Bonus Conditions:
                                    <ul>
                                        <li>
                                            Use code <span className="text-primary fw-bold">"SEBM"</span> on Sign Up
                    ...
                    <div className="col-md-6 col-lg-4  ">
                        <div className={`${styles.card}  card my-2 card-yellow`}>
                            <div className={`${styles.cardImgTopWrapper} m-auto`}>
                                <img src={card_3_img} className={`${styles.cardImgTop} card-img-top mw-100`} alt="..." />
                            </div>
                            <div className="card-body">
                                <h5 className="fw-bold text-center">100% Deposit Bonus</h5>
                                <div className="card-text">Bonus Conditions:
