...
import herobg from "../../../assets/images/bgbaner.png";
import diamond from "../../../assets/images/Dynamite.png";
import burnere from "../../../assets/images/burner.png";
import Globe from "../../../assets/images/Globelow.png";
...
const Hero = () => {
    ...
    return (
        ...
        <div>
            ...
            <img   className={`heroobanner w-100 h-100`} src={herobg} alt=""  style={{'position':'absolute'}}   data-aos="fade-up" data-aos-delay="10" data-aos-offset="200"/>
            <img  className={`${styles.globeimage} `} src={Globe} alt=""  />
            
<div style={{'position':'relative','top':'100px'}}>
    
<h1 data-aos="fade-down" style={{'z-index':'1000000'}} className={`text-center    ${styles.title} `}> <span className="text-primary">Welcome to  <span className='fw-bold'> RambleRewards</span>
</span></h1>
