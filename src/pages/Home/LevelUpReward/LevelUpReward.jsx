...
const LevelUpReward = () => {
    return (
        <div className="container">
            <div data-aos="fade-right" data-aos-offset="300" className='inner-container d-flex flex-column gap-md-5'>
                <h1 id='Bonuses' className={`${styles.title} text-center py-md-4`}>Exclusive Level Up Rewards</h1>
                <div className="row gap-md-5 flex-column-reverse flex-md-row">
                    <div className="col-md align-self-center text-center text-md-start">
                        <p>
