...
const MonthlyLeaderboard = () => {
    return (
        <div className="container">
            <div data-aos="fade-up" data-aos-offset="300" className='inner-container d-flex flex-column gap-md-5'>
                <h1 id='Bonuses' className={`${styles.title} text-center py-md-4`}>$10,000 Monthly Leaderboard</h1>
